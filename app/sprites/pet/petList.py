...
class PetList:
    def __init__(self):
        ...
        #Tier3
        self.pet["chocoRabbit"] = Pet('chocoRabbit','rabbit made of gold','lapin-chocolat.png', 250,kind=DEAD_END,eventTrigger=True)
        self.pet["carrotRabbit"] = Pet('carrotRabbit','playful rabbit','lapin-carotte.png', 250,kind=DEAD_END)
        self.pet["orangeRabbit"] = Pet('orangeRabbit','weird orange rabbit', 'lapin-tigre-carotte.png', 250,kind=DEAD_END)
        self.pet["alienRabbit"] = Pet('alienRabbit','rabbit from outer space','lapin-alien.png', 250,kind=DEAD_END,eventTrigger=True)
