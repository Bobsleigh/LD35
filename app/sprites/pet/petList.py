...
class PetList:
    def __init__(self):
        ...
        self.pet["carrotRabbit"] = Pet('carrotRabbit','playful rabbit','lapin-carotte.png', 250,deadEnd=True,eventTrigger=True)
        self.pet["orangeRabbit"] = Pet('orangeRabbit','weird orange rabbit', 'lapin-tigre-carotte.png', 250)
        self.pet["alienRabbit"] = Pet('alienRabbit','rabbit form outer space','lapin-alien.png', 250,deadEnd=True,eventTrigger=True)
        ...
        #Tier30
        self.pet["dog"] = Pet('dog','nice dog', 'chien.png', 275,deadEnd=True,eventTrigger=True)
        self.pet["muscularHorse"] = Pet('muscularHorse','powerful horse', 'cheval-pomme.png', 325,deadEnd=True,eventTrigger=True)
        ...
        self.pet["pimpUnicorn"] = Pet('pimpUnicorn', 'badass unicorn', 'licorne-pimp.png', 325,deadEnd=True,eventTrigger=True)
